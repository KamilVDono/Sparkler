...
namespace XNode.Editor
{
	...
	public partial class NodeEditorWindow
	{
		...
		/// </summary>
		public static Dictionary<Type, Color> nodeTint => _nodeTint != null ? _nodeTint : _nodeTint = GetNodeTint();
		...
		/// </summary>
		public static Dictionary<Type, int> nodeWidth => _nodeWidth != null ? _nodeWidth : _nodeWidth = GetNodeWidth();
		...
		public static Type[] GetNodeTypes() =>
			...
			GetDerivedTypes( typeof( XNode.Node ) );
