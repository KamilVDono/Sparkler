...
{
	/// <summary>
	/// Base class for class selection constraints that can be applied when selecting a <see
	/// cref="ClassTypeReference"/> with the Unity inspector.
	/// </summary>
	public abstract class ClassTypeConstraintAttribute : PropertyAttribute
	{
		...
		/// <summary>
		/// Gets or sets grouping of selectable classes. Defaults to <see
		/// cref="ClassGrouping.ByNamespaceFlat"/> unless explicitly specified.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets whether abstract classes can be selected from drop-down. Defaults to a
		/// value of <c>false</c> unless explicitly specified.
		/// </summary>
		public bool AllowAbstract
		{
			get => this.allowAbstract;
		...
		/// </returns>
		public virtual bool IsConstraintSatisfied( Type type ) => this.AllowAbstract || !type.IsAbstract;
	}
}