...
{
	/// <summary>
	/// Constraint that allows selection of classes that extend a specific class when selecting a
	/// <see cref="ClassTypeReference"/> with the Unity inspector.
	/// </summary>
	...
	public sealed class ClassExtendsAttribute : ClassTypeConstraintAttribute
	{
		...
		public ClassExtendsAttribute( Type baseType ) => this.BaseType = baseType;
