...
namespace Sparkler.XNode
{
	...
	public class NodePort
	{
		...
		/// <summary>
		/// Construct a dynamic port. Dynamic ports are not forgotten on reimport, and is ideal for
		/// runtime-created ports.
		/// </summary>
		...
		/// <summary>
		/// Connect this <see cref="NodePort"/> to another
		/// </summary>
		...
		/// </summary>
		public List<Vector2> GetReroutePoints( int index ) => connections[index].reroutePoints;
