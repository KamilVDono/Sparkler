...
namespace Sparkler.XNode
{
	...
	public static class NodeDataCache
	{
		...
		public static void UpdatePorts( Node node, Dictionary<string, NodePort> ports )
		{
			...
			if ( portDataCache.TryGetValue( nodeType, out List<NodePort> typePortCache ) )
			{
			...
			// Cleanup port dict - Remove nonexisting static ports - update static port types Loop
			// through current node ports
		...
		public static List<FieldInfo> GetNodeFields( System.Type nodeType )
		{
			...
			// GetFields doesnt return inherited private fields, so walk through base types and pick
			// those up
